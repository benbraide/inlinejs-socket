...
class SocketEvent extends inlinejs_element_1.CustomElement {
    ...
    FindChannel_() {
        return (this.channel_ = (this.channel_ || (0, inlinejs_1.FindAncestor)(this, ancestor => ('Subscribe' in ancestor))));
    }
    FindNative_() {
        var _a;
        return (((_a = (0, inlinejs_1.FindAncestor)(this, ancestor => ('GetNative' in ancestor))) === null || _a === void 0 ? void 0 : _a.GetNative()) || null);
    }
}
__decorate([
