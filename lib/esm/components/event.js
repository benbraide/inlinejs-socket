...
export class SocketEvent extends CustomElement {
    ...
    FindChannel_() {
        return (this.channel_ = (this.channel_ || FindAncestor(this, ancestor => ('Subscribe' in ancestor))));
    }
    FindNative_() {
        var _a;
        return (((_a = FindAncestor(this, ancestor => ('GetNative' in ancestor))) === null || _a === void 0 ? void 0 : _a.GetNative()) || null);
    }
}
__decorate([
