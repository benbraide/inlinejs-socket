import { AddChanges, FindComponentById, GetGlobal, IsObject } from '@benbraide/inlinejs';
...
export class SocketClient extends CustomElement {
    constructor() {
        ...
        this.componentId_ = (((_a = GetGlobal().InferComponentFrom(this)) === null || _a === void 0 ? void 0 : _a.GetId()) || '');
        this.io_ = io(this.state_.path || undefined);
        this.io_.on('connected', (id) => {
            var _a;
            this.connected_ = true;
            this.changesId_ && AddChanges('set', `${this.changesId_}.connected`, 'connected', (_a = FindComponentById(this.componentId_)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
            this.dispatchEvent(new CustomEvent('connected', { detail: (this.id_ = id) }));
        });
        let resolvedComponent = FindComponentById(this.componentId_), elementScope = resolvedComponent === null || resolvedComponent === void 0 ? void 0 : resolvedComponent.CreateElementScope(this);
        if (resolvedComponent) {
            ...
            const componentId = resolvedComponent.GetId(), this_ = this, proxy = {
                ...
                get connected() {
                    var _a;
                    (_a = FindComponentById(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes.AddGetAccess(`${this_.changesId_}.connected`);
    ...
    toggleConnected_(connected) {
        ...
        if (this.connected_ !== connected) {
            ...
            if (!connected) {
                this.connected_ = false;
                this.changesId_ && AddChanges('set', `${this.changesId_}.connected`, 'connected', (_c = FindComponentById(this.componentId_)) === null || _c === void 0 ? void 0 : _c.GetBackend().changes);
            }
        }
    }
}
